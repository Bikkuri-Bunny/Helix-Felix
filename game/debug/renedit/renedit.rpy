...
### Images
image addnotebase = "debug/renedit/addnotebase.png"
image logtypobase = "debug/renedit/logtypo.png"
image logtypohover = Fixed("debug/renedit/logtypohover.png",Transform(Text("[tl_log_typo]",text_align=0.5,color="#fff",size=36,bold=True),xpos=.15))
image addnotehover = Fixed("debug/renedit/addnotehover.png",Transform(Text("[tl_add_note]",text_align=0.5,color="#fff",size=36,bold=True),xpos=.15))
