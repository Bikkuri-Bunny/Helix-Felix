screen input_note(prompt):
    ...
    vbox:
        ...
        add "debug/renedit/addnotebase.png" xalign 0.5 # Icon for decoration
        label _("{color=#90a6ad}Write your note below.\n") xalign 0.5 text_outlines [(absolute(2),renedit_blue,0,0)] # Prompt
        input id "input" color "#90a6ad" outlines [(absolute(2),renedit_blue,0,0)] caret Transform("debug/renedit/pen.png",xzoom=-1,ypos=-0.2) # Input styling
