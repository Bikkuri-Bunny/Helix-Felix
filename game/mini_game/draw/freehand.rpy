# code https://github.com/jsfehler/renpy-freehand-draw
init python:
    import pygame
    ...
    class FreehandCanvas(renpy.Displayable):
        ...
        def event(self, ev, x, y, st):
            if renpy.map_event(ev, 'mousedown_1'):
                ...
                #self.surface=pygame.display.get_surface() #guardar la imagen pygame_surf
                #self.surface=renpy.display.pgrender.surface((880, 480), True)
                #self.surface=pygame.image.load(self.current_child)
                renpy.redraw(self, 0)
        ...
        #   #renpy.image(name, self)
        #   pygame.image.save(self.surface,renpy.config.gamedir+'/temp_dev22.jpeg')
